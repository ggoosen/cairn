...
func TestThreadExpansion(t *testing.T) {
	...
	out, err := d.Thread(daemon.ThreadOptions{ThreadID: root.MessageID, BudgetChars: 4000})
	if err != nil {
		t.Fatal(err)
	}
	...
	if _, err := d.Thread(daemon.ThreadOptions{ThreadID: "0190a1b2-c3d4-7e5f-8901-000000000000", BudgetChars: 1000}); err == nil {
