...
> **STATUS: COMPLETE — HISTORICAL.** Every milestone here (M0–M8, plus the
> post-P0 M9 ingest stub) is built and recorded in PROGRESS.md. This file is
> retained for its acceptance criteria and decision trail, **not as a work
> queue**, and it is not a plan document any more.
>
> **For everything still to be built, read
> [`BUILD-PLAN.md`](BUILD-PLAN.md)** — the single source of truth.
